...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 22, 2024 at 07:27 AM
...
INSERT INTO `booking_history` (`id`, `user_id`, `user_email`, `booking_date`, `booking_time`, `counselor_name`, `country_name`, `service_name`, `price`, `created_at`) VALUES
(1, 7, 'phonewaiyanmoe9@gmail.com', '2024-08-08', '01:59:07', 'hello3', 'Thai', 'Visa', 100.00, '2024-08-21 17:33:36');
...
(1, '+1234567890', 'lannsa.org@gmail.com', 'https://www.facebook.com/profile.php?id=61564524301596&mibextid=ZbWKwL', 'https://instagram.com/yourprofile', 'https://youtube.com', '2024-08-11 07:09:33', '2024-08-22 05:06:26');
...
(2, 9, 'Visa', 'Lan-Sa-main/web/images/services/thai.jpeg', 100.00),
(12, 9, 'Scholar', 'Lan-Sa-main/web/images/services/thai.jpeg', 200.00),
(13, 9, 'Visa', 'Lan-Sa-main/web/images/services/thai.jpeg', 300.00);
...
(7, 'Phone Wai Yan Moe', 'phonewaiyanmoe9@gmail.com', '9420065505', '$2y$10$Ybi7pf5tOlxDU5XKI4Y4QuRqlK4p7NkONdnlvtmyTTPIQLyBx8b5O', '', 'uploads/default_image.svg', '2024-08-21 17:15:32', 1, 0);
...
--
-- Constraints for table `service_dates`
--
ALTER TABLE `service_dates`
  ADD CONSTRAINT `service_dates_ibfk_1` FOREIGN KEY (`service_id`) REFERENCES `services` (`id`);
